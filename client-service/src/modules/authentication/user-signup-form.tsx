...
import { useVerifyCustomer } from "./hook/use-verify-customer"

type UserSignUpFormProps = React.ComponentProps<"div"> & {
    onChangeCustomer?: (value: boolean) => void;
    onActionBefore?: (value: boolean) => void;
}
export function UserSignUpForm({
    ...
    const { handleSignup } = useVerifyCustomer({onChangeCustomer});
    ...
    function handleClick(e: React.MouseEvent<HTMLAnchorElement>) {
        ...
        onActionBefore && onActionBefore(true);
    }
                            ...
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <p className="text-balance text-muted-foreground">
                                        Đăng ký tài khoản Acme Inc của bạn
                                    </p>
                                </div>
                                <FormField
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>kiểm tra tương khớp mật khẩu</FormLabel>
                                            <FormControl>
                                ...
                                <div className="text-center text-sm">
                                    ...
                                    <Link href="#" onClick={handleClick} className="underline underline-offset-4">
                                        Đăng nhập
                                    </Link>
                                </div>
                            </div>
