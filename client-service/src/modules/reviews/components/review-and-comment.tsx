                ...
                <div className="w-full">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-11 pb-11 border-b border-gray-100 max-xl:max-w-2xl max-xl:mx-auto">
                        ...
                        <div className="p-8 bg-amber-50 rounded-3xl flex items-center justify-center flex-col">
                            <h2 className="font-manrope font-bold text-2xl text-amber-400 mb-6">
                                4.3
                            </h2>
                            ...
                            <p className="font-medium text-lg leading-6 text-gray-900 text-center">
                                46 Ratings
                            </p>
                        </div>
                    </div>
                    {
                        [0, 1, 2, 3].map(i => (
                            <div className="pt-2 p-2 border-b border-gray-100 max-xl:max-w-2xl max-xl:mx-auto">
                                ...
                                <h3 className="font-manrope font-semibold text-xl leading-6 text-black mb-2">
                                ...
                                <p className="font-normal text-md max-xl:text-justify">
