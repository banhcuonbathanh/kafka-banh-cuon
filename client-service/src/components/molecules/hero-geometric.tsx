...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-60 md:min-h-80 w-full flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    <motion.div
                        ...
                        animate="visible"
                    >
                        <h1 className="text-4xl md:text-6xl font-bold mb-4 md:mb-8 tracking-tight">
                            <span
                                className={cn(
